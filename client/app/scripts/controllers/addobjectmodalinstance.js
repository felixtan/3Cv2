...
angular.module('clientApp')
  .controller('AddObjectModalInstanceCtrl', function ($window, $timeout, getCars, getAssets, getProspects, getDrivers, objectType, $q, $modal, objectHelpers, assetHelpers, prospectHelpers, carHelpers, driverHelpers, dataService, $scope, $modalInstance, $state) {
    ...
    ctrl.hideExpressions = function(referenceObjectData) {
        var deferred = $q.defer();
        // console.log($scope.objects);
        deferred.resolve(_.each(referenceObjectData, function(data, field) {
            // console.log(data);
    ...
    if($scope.objectType === 'driver') {
        ...
        ctrl.getFormDataAndReference('driver').then(function(result) {
            ctrl.hideExpressions(result.referenceObject.data).then(function() {
                // console.log(result.referenceObject.data);
