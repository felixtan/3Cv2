          ...
          */
          function updateExpressionNameInFields (oldName, newName, object) {
              ...
              */
              ...
              deferred.resolve(object);
              deferred.reject(new Error("Error replacing " + oldName + " with " + newName + " for expressionsUsedIn for field " + fieldVal));
              return deferred.promise;
          }
          ...
          */
          function updateFieldNameInExpressions (oldName, newName, object) {
                ...
                */
                ...
                deferred.resolve(object);
                deferred.reject(new Error("Error replacing " + oldName + " with " + newName + " for fields used in expressions " + expressionFieldVal.name));
                return deferred.promise;
          }
