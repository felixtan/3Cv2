...
describe('CarListCtrl', function () {
  ...
  describe('simplified cars', function() {
    xit('should store a simplified version of the cars', function() {
      state.go('dashboard.cars');
      setTimeout(function() {
    ...
    xit('should have the same amount of simplified cars as full cars', function() {
      state.go('dashboard.cars');
      setTimeout(function() {
  ...
  describe('car identifier', function() {
    xit('should load the car identifier to scope', function() {
      expect(scope.identifier).toBeDefined();
    });

    xit('should organize the cars in the view by identifier', function() {
    ...
    xit('should determine if there is at least one car', function() {
