...
describe('Controller: AddFieldModalInstanceCtrl', function () {
  ...
  describe("set inequality sign", function() {
    ...
    it("should set the inequality sign to undefined given inappropriate id", function() {
  ...
  describe("set field data type given field type", function() {
    ...
    it("should set to boolean given boolean", function() {
    ...
    it("should set to number given function", function() {
    ...
    it("should set to boolean given inequality", function() {
    ...
    it("should set to undefined given unrecognized type", function() {
      scope.setDataType(0);
      expect(scope.clearExpression).toHaveBeenCalled();
      // setTimeout(function() {
  ...
  describe("it should disable submit button if invalied field", function() {
    it("should return true if field type is null", function() {
      scope.field.type = null;
      scope.field.dataType = 'text';
      expect(scope.invalidFieldType()).toBe(true);
    });

    it("should return true if field type is undefined", function() {
      scope.field.type = undefined;
      scope.field.dataType = 'text';
      expect(scope.invalidFieldType()).toBe(true);
    });

    it("should return true if field data type is null", function() {
    ...
    it("should return false if field type and dataType are defined", function() {
  ...
  describe("it should append an item to an expression and then validate it", function() {
    it("should append items to functions", function() {
      scope.field.type = 'function';
  ...
  describe("it should validate test expressions", function() {
    ...
    describe("general validation", function() {
      ...
      it("should involve multiple stages of validation", function() {
      ...
      it("should proceed to second stage validation if the test expression passes the first", function() {
      ...
      it("should not proceed to second stage validation if the test expression fails the first", function() {
        var testExpressionItems = [{ type: 'constant', value: '3.14' }];
        var typeOfNewItem = 'field';
        var newItem = 'mileage';
    ...
    describe("first stage validation", function() {
      ...
      it("should evaluate expressions to be invalid if fields are not preceeded or followed by an operator", function() {
        var testExpressionItems = [{ type: 'constant', value: '3.14' }];
        var typeOfNewItem = 'field';
        var newItem = 'mileage';
      ...
      it("should evaluate expressions to be invalid if constants are not preceeded or followed by an operator", function() {
      ...
      it("should replace field value with 1 before pushing to testExpressionItems", function() {
      ...
      it("should push constants to testExpressionItems as long as an operator preceeded it or if it's the first item", function() {
        var testExpressionItems = [{ type: 'field', value: '1' }, { type: 'operator', value: '*' }];
        var typeOfNewItem = 'constant';
        var newItem = '3.14';
      ...
      it("should evaluate expressions to be valid if constants are preceeded or followed by an operator", function() {
        var testExpressionItems = [{ type: 'field', value: '1' }];
        var typeOfNewItem = 'operator';
        var newItem = '*';
      ...
      it("should evaluate expressions to be valid if fields are preceeded or followed by an operator", function() {
    ...
    describe("mid stage functions", function() {
      ...
      it("should build a test expression out of testExpressionItems", function() {
      ...
      it("should build a test expression out of testExpressionItems even if it's invalid", function() {
      ...
      it("should build a display expression out of testExpressionItems where field names are shown", function() {
    ...
    describe("second stage validation", function() {
      it("should evaluate expressions to be valid if they're valid", function() {
      ...
      it("should throw when invalid expressions", function() {
      ...
      it("should throw when invalid expressions - parens", function() {
        ctrl.testExpression = "3.14*1)";
        ctrl.validateExpression();
        expect(scope.expressionErrorMessage).toBeString();
        expect(scope.$eval).toHaveBeenCalledWith(ctrl.testExpression);
  ...
  describe("undo expression", function() {
    ...
    it("should remove last item from function", function() {
      scope.field.type = 'function';
      scope.field.expressionItems = ctrl.testExpressionItems = [{ type: 'constant', value: '3.14'}];
      scope.undoExpression();
  ...
  // reasses if i actually need it or can use the original firstStageValidate
  describe("evaluate expression after undo", function() {
    ...
    it("should return true if testExpressionItems has 1 item", function() {
      scope.field.type = 'function';
    ...
    it("should not throw error if the new last item is an operator", function() {
      scope.field.type = 'function';
    ...
    it("should throw error if the new last item is a field and item before it is not an operator", function() {
      scope.field.type = 'function';
    ...
    it("should throw error if the new last item is a constant and item before it is not an operator", function() {
      scope.field.type = 'function';
    ...
    it("should be good if the new last item is a field and item before it is an operator", function() {
      scope.field.type = 'function';
  ...
  it("should clear $scope.field", function() {
  ...
  describe('object type recognition', function() {
    it('should recognize if object type is car and load cars', function() {
      if(objectType === 'car') {
    ...
    it('should recognize if object type is driver and load drivers', function() {
    ...
    it('should recognize if object type is prospect and load prospects', function() {
    ...
    it('should recognize if object type is asset and load assets', function() {
      if(objectType === 'asset') {
    ...
    it("should redirect to car dashboard if invalid object type", function() {
      if(objectType !== 'car' 
        && objectType !== 'driver' 
        && objectType !== 'prospect' 
        && objectType !== 'asset') {
  ...
  describe("createNewFieldData", function() {
    ...
    it("should return a data object for function field", function() {
      scope.field.type = 'function';
      scope.field.dataType = 'number';
    ...
    it("should return a data object for inequality field", function() {
      scope.field.type = 'inequality';
    ...
    it("should return a data object for text fields", function() {
    ...
    it("should return a data object for number fields", function() {
      scope.field.type = 'number';
      scope.field.dataType = 'number';
      scope.formData.log = true;
    ...
    it("should return a data object for boolean fields", function() {
  ...
  it('should append new field to object', function() {
    var fieldName = 'test';
    var fieldDataObj = {
      log: true,
      value: null,
  ...
  describe("evaluate inequality value", function() {
    ...
    it("should evaluate ge", function() {
      var leftExpressionValue = 1,
  ...
  describe("determine if inequality expression is non empty", function() {
    ...
    it("should return false if rightExpressionItems is empty", function() {
      scope.field.rightExpressionItems = [];
      expect(scope.inequalityIsComplete()).toEqual(false);
    });

    it("should return false if leftExpressionItems is empty", function() {
      scope.field.leftExpressionItems = [];
      expect(scope.inequalityIsComplete()).toEqual(false);
    });

    it("should return false if inequalitySign is empty", function() {
    ...
    it("should return true if right and left expressionItems are unempty and inequalitySign is valid", function() {
      expect(scope.inequalityIsComplete()).toEqual(true);
    });

    it("should return true if not an inequality - function", function() {
      scope.field.type = 'function';
      expect(scope.inequalityIsComplete()).toEqual(true);
    });

    it("should return true if not an inequality - number", function() {
      scope.field.type = 'number';
      expect(scope.inequalityIsComplete()).toEqual(true);
    });

    it("should return true if not an inequality - text", function() {
      scope.field.type = 'text';
      expect(scope.inequalityIsComplete()).toEqual(true);
    });

    it("should return true if not an inequality - boolean", function() {
      scope.field.type = 'boolean';
      expect(scope.inequalityIsComplete()).toEqual(true);
    });
  });
  ...
  describe("determine if general expression is empty", function() {
    it("should return true only if expressionItems empty - function", function() {
      scope.field.type = 'function';
      scope.field.expressionItems = ['foo'];
      expect(scope.emptyExpression()).toEqual(false);
    });

    it("should return false only if expressionItems non empty - function", function() {
      scope.field.type = 'function';
      scope.field.expressionItems = [];
      expect(scope.emptyExpression()).toEqual(true);
    });

    it("should return false only if expressionItems non empty - left", function() {
      scope.field.type = 'inequality';
      scope.field.leftExpressionItems = [];
    ...
    it("should return false only if expressionItems non empty - right", function() {
      scope.field.type = 'inequality';
    ...
    it("should return false only if expressionItems non empty - empty", function() {
      scope.field.type = 'inequality';
      scope.field.leftExpressionItems = [];
      scope.field.rightExpressionItems = [];
      scope.inequalitySignId = 1;
    ...
    it("should return true for non expression fields - text", function() {
      scope.field.type = 'text';
      expect(scope.emptyExpression()).toEqual(false);
    });

    it("should return true for non expression fields - number", function() {
      scope.field.type = 'number';
      expect(scope.emptyExpression()).toEqual(false);
    });

    it("should return true for non expression fields - boolean", function() {
      scope.field.type = 'boolean';
      expect(scope.emptyExpression()).toEqual(false);
    });
  });
  ...
  describe('build and evaluate expression for object', function() {
    ...
    it("should build expression for an object", function() {
    ...
    it("should evaluate an expression for object", function() {
  ...
  describe('submit', function() {
    ...
    it("should update all objects in field is function", function() {
      scope.field.type = 'function';
      scope.submit();
    ...
    it("should update all objects in field is inequality", function() {
      scope.field.type = 'inequality';
      scope.field.inequalitySignId = 0;
      scope.submit();
    ...
    it("should update all objects in field is number", function() {
      scope.field.type = 'number';
      scope.submit();
    ...
    it("should update all objects in field is boolean", function() {
      scope.field.type = 'boolean';
      scope.submit();
    ...
    it("should update all objects in field is text", function() {
      scope.field.type = 'text';
      scope.submit();
