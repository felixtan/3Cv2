...
describe('CarsLogsCtrl', function () {
  ...
  describe("", function() {
    ...
    xit("should call certain functions upon entering the state", function() {
      state.go('logs.cars');
    ...
    xit("should integrate angular ui bootstrap datepicker", function() {
    ...
    xit("should load the identifier if there are cars", function() {
      expect(scope.identifier).toBeDefined();
      if(scope.cars.length) expect(scope.identifier).toEqual(scope.cars[0].identifier);
    });

    xit("should store a simplified version of cars", function() {
    ...
    xit("stores existing log dates in reverse temporal order", function() {
    ...
    xit("should add a new log to a car", function() {
    ...
    xit("should create new log for cars", function() {
      scope.newLog();
